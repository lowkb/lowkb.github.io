...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function co(){return new gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ua(),fragmentShader:`
		...
		`,blending:pn,depthTest:!1,depthWrite:!1})}function uo(){return new gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ua(),fragmentShader:`
...
#define LOW_PRECISION`),e}function _p(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ko?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===zl?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===en&&(e="SHADOWMAP_TYPE_VSM"),e}function gp(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case ri:case si:e="ENVMAP_TYPE_CUBE";break;case vr:e="ENVMAP_TYPE_CUBE_UV";break}return e}function vp(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case si:e="ENVMAP_MODE_REFRACTION";break}return e}function xp(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Wo:e="ENVMAP_BLENDING_MULTIPLY";break;case rc:e="ENVMAP_BLENDING_MIX";break;case sc:e="ENVMAP_BLENDING_ADD";break}return e}function Mp(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:n,maxMip:t}}function Sp(i,e,t,n){const r=i.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=_p(t),c=gp(t),f=vp(t),u=xp(t),d=Mp(t),m=lp(t),v=cp(s),M=r.createProgram();let p,h,T=t.glslVersion?"#version "+t.glslVersion+`
...
`].filter(vi).join(`
`)),a=Ys(a),a=Eo(a,t),a=yo(a,t),o=Ys(o),o=Eo(o,t),o=yo(o,t),a=To(a),o=To(o),t.isRawShaderMaterial!==!0&&(T=`#version 300 es
...
`,"- lowScript",`
`,"- WebRTC Chat",`
`,"- Dashboard UI"]})}function Jp(){return Ct("div",{className:"icon",children:[Ct(Zp,{}),Ct("div",{className:"informations",children:Ct(jp,{})})]})}function Qp(){const[e,t]=ss(0),[n,r]=ss(0);Qs(()=>{const a=setInterval(()=>{r(o=>(o+1)%4),t(o=>Math.min(o+1,10))},300);return()=>clearInterval(a)},[]);const s="["+"#".repeat(e)+" ".repeat(10-e)+"]";return Ct("div",{className:"loader",children:Ct("div",{className:"loader-box",children:[Ct("div",{className:"loader-text",children:"> loading low_kb shell"+".".repeat(n)}),Ct("div",{className:"loader-bar",children:s})]})})}function em(){const[i,e]=ss(!0);return Qs(()=>{if(document.readyState==="complete"){e(!1);return}const t=()=>e(!1);return window.addEventListener("load",t),()=>window.removeEventListener("load",t)},[]),i?Ct(Qp,{}):Ct(Jp,{})}Pl(Ct(em,{}),document.getElementById("home"));

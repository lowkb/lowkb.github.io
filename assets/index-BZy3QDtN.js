...
`,"- lowScript",`
`,"- WebRTC Chat",`
`,"- Dashboard UI"]})}function Jp(){return Ut("div",{className:"app",children:[Ut("div",{className:"left",children:Ut(Zp,{})}),Ut("div",{className:"right",children:Ut(jp,{})})]})}function Qp(){return Ut("div",{class:"loader-screen",children:Ut("div",{class:"loader-text",children:"Loading low_kb shell..."})})}function em(){const[i,e]=Dl(!0);return zo(()=>{const t=setTimeout(()=>e(!1),2e3);return()=>clearTimeout(t)},[]),i?Ut(Qp,{}):Ut(Jp,{})}Cl(Ut(em,{}),document.getElementById("home"));
